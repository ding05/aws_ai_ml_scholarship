...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            # REPLACE pass with CODE to remove the newline character
            # from the variable line  
            #
            # Process line by striping newline from line
            line = line.rstrip()

            # REPLACE pass with CODE to check if the dogname(line) 
    ...
    for key, value in results_dic.items():
        ...
        if value[0] in dognames_dic:
            ...
            # REPLACE pass BELOW with CODE that adds the following to
